...
class Participant:
    ...
    def __init__(self, participant_id, name, build, logic, variables=None, behaviours=None, robot_version_id=None):
    ...
    def new_robot(self):
        return Robot(self.id, self.name, x=0, y=0, direction=0,
                      build=self.build, logic=self.logic,
                      variables=self.variables, behaviours=self.behaviours)
